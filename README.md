# Ecommerce-Sales
📌 Project Overview
This project focuses on analyzing retail sales data using Microsoft Excel to identify key business insights and trends. The interactive dashboard provides a clear view of store performance, product sales, payment methods, customer contribution, discount impact, and yearly revenue trends.
